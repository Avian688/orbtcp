...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPIPCUTOFFFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPIPCUTOFFFLAVOUR_H_
...
/**
 * State variables for OrbtcpIPCutOff.
 */
typedef OrbtcpFamilyStateVariables OrbtcpIPCutOffStateVariables;

/**
 * Implements OrbTCP.
 */
class OrbtcpIPCutOffFlavour : public OrbtcpFamily
{
  protected:
    OrbtcpIPCutOffStateVariables *& state;
    ...
    bool initPackets;
    /** Create and return a OrbtcpIPCutOffStateVariables object. */
    virtual TcpStateVariables *createStateVariables() override
    {
        return new OrbtcpIPCutOffStateVariables();
    }
