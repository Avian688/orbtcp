...
Register_Class(OrbtcpNoSSFlavour);

simsignal_t OrbtcpNoSSFlavour::txRateSignal = cComponent::registerSignal("txRate");
simsignal_t OrbtcpNoSSFlavour::tauSignal = cComponent::registerSignal("tau");
simsignal_t OrbtcpNoSSFlavour::uSignal = cComponent::registerSignal("u");
simsignal_t OrbtcpNoSSFlavour::USignal = cComponent::registerSignal("U");
simsignal_t OrbtcpNoSSFlavour::additiveIncreaseSignal = cComponent::registerSignal("additiveIncrease");
simsignal_t OrbtcpNoSSFlavour::sharingFlowsSignal = cComponent::registerSignal("sharingFlows");
simsignal_t OrbtcpNoSSFlavour::bottleneckBandwidthSignal = cComponent::registerSignal("bottleneckBandwidth");
simsignal_t OrbtcpNoSSFlavour::avgRttSignal = cComponent::registerSignal("avgRtt");
simsignal_t OrbtcpNoSSFlavour::queueingDelaySignal = cComponent::registerSignal("queueingDelay");
simsignal_t OrbtcpNoSSFlavour::estimatedRttSignal = cComponent::registerSignal("estimatedRtt");
simsignal_t OrbtcpNoSSFlavour::avgEstimatedRttSignal = cComponent::registerSignal("avgEstimatedRtt");

OrbtcpNoSSFlavour::OrbtcpNoSSFlavour() : OrbtcpFamily(),
    state((OrbtcpNoSSStateVariables *&)TcpAlgorithm::state)
{
}

void OrbtcpNoSSFlavour::initialize()
{
...
void OrbtcpNoSSFlavour::established(bool active)
{
...
void OrbtcpNoSSFlavour::rttMeasurementComplete(simtime_t tSent, simtime_t tAcked)
{
    //
...
void OrbtcpNoSSFlavour::receivedDataAckInt(uint32_t firstSeqAcked, IntDataVec intData)
{
...
double OrbtcpNoSSFlavour::measureInflight(IntDataVec intData)
{
    double u = 0;
    double tau;
...
uint32_t OrbtcpNoSSFlavour::computeWnd(double u, bool updateWc)
{
    uint32_t w;
...
size_t OrbtcpNoSSFlavour::getConnId()
{
    return connId;
}

simtime_t OrbtcpNoSSFlavour::getSrtt()
{
    //return state->srtt;
    return estimatedRtt;
}

unsigned int OrbtcpNoSSFlavour::getCwnd()
{
