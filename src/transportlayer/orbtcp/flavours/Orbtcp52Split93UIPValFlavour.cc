...
#include "Orbtcp52Split93UIPValFlavour.h"
...
Register_Class(Orbtcp52Split93UIPValFlavour);

simsignal_t Orbtcp52Split93UIPValFlavour::txRateSignal = cComponent::registerSignal("txRate");
simsignal_t Orbtcp52Split93UIPValFlavour::tauSignal = cComponent::registerSignal("tau");
simsignal_t Orbtcp52Split93UIPValFlavour::uSignal = cComponent::registerSignal("u");
simsignal_t Orbtcp52Split93UIPValFlavour::USignal = cComponent::registerSignal("U");
simsignal_t Orbtcp52Split93UIPValFlavour::additiveIncreaseSignal = cComponent::registerSignal("additiveIncrease");
simsignal_t Orbtcp52Split93UIPValFlavour::sharingFlowsSignal = cComponent::registerSignal("sharingFlows");
simsignal_t Orbtcp52Split93UIPValFlavour::bottleneckBandwidthSignal = cComponent::registerSignal("bottleneckBandwidth");
simsignal_t Orbtcp52Split93UIPValFlavour::avgRttSignal = cComponent::registerSignal("avgRtt");
simsignal_t Orbtcp52Split93UIPValFlavour::queueingDelaySignal = cComponent::registerSignal("queueingDelay");
simsignal_t Orbtcp52Split93UIPValFlavour::estimatedRttSignal = cComponent::registerSignal("estimatedRtt");
simsignal_t Orbtcp52Split93UIPValFlavour::avgEstimatedRttSignal = cComponent::registerSignal("avgEstimatedRtt");
simsignal_t Orbtcp52Split93UIPValFlavour::alphaSignal = cComponent::registerSignal("alpha");

Orbtcp52Split93UIPValFlavour::Orbtcp52Split93UIPValFlavour() : OrbtcpFamily(),
    state((Orbtcp52Split93UIPValStateVariables *&)TcpAlgorithm::state)
{
}

void Orbtcp52Split93UIPValFlavour::initialize()
{
...
void Orbtcp52Split93UIPValFlavour::established(bool active)
{
...
void Orbtcp52Split93UIPValFlavour::rttMeasurementComplete(simtime_t tSent, simtime_t tAcked)
{
    //
...
void Orbtcp52Split93UIPValFlavour::receivedDataAckInt(uint32_t firstSeqAcked, IntDataVec intData)
{
...
double Orbtcp52Split93UIPValFlavour::measureInflight(IntDataVec intData)
{
    double u = 0;
    double tau;
...
uint32_t Orbtcp52Split93UIPValFlavour::computeWnd(double u, bool updateWc)
{
    uint32_t w;
...
size_t Orbtcp52Split93UIPValFlavour::getConnId()
{
    return connId;
}

simtime_t Orbtcp52Split93UIPValFlavour::getSrtt()
{
    //return state->srtt;
    return estimatedRtt;
}

unsigned int Orbtcp52Split93UIPValFlavour::getCwnd()
{
