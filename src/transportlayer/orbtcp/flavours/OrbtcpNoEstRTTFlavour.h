...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPNOESTRTTFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPNOESTRTTFLAVOUR_H_
 ...
 * Implements OrbTCP.
 */
class OrbtcpNoEstRTTFlavour : public OrbtcpFamily
{
  protected:
