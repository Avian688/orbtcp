...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPNOSSFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPNOSSFLAVOUR_H_
 ...
 */
typedef OrbtcpFamilyStateVariables OrbtcpNoSSStateVariables;

/**
 * Implements OrbTCPNoSS.
 */
class OrbtcpNoSSFlavour : public OrbtcpFamily
{
  protected:
    OrbtcpNoSSStateVariables *& state;
    ...
    {
        return new OrbtcpNoSSStateVariables();
    }
