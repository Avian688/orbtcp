...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_Orbtcp23SPLITIPVALFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_Orbtcp23SPLITIPVALFLAVOUR_H_
...
/**
 * State variables for Orbtcp23SplitIPValFlavour.
 */
typedef OrbtcpFamilyStateVariables Orbtcp23SplitIPValStateVariables;

/**
 * Implements Orbtcp23SplitIPValFlavour.
 */
class Orbtcp23SplitIPValFlavour : public OrbtcpFamily
{
  protected:
    Orbtcp23SplitIPValStateVariables *& state;
    ...
    {
        return new Orbtcp23SplitIPValStateVariables();
    }
