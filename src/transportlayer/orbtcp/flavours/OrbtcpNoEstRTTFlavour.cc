...
#include "OrbtcpNoEstRTTFlavour.h"
...
Register_Class(OrbtcpNoEstRTTFlavour);

simsignal_t OrbtcpNoEstRTTFlavour::txRateSignal = cComponent::registerSignal("txRate");
simsignal_t OrbtcpNoEstRTTFlavour::tauSignal = cComponent::registerSignal("tau");
simsignal_t OrbtcpNoEstRTTFlavour::uSignal = cComponent::registerSignal("u");
simsignal_t OrbtcpNoEstRTTFlavour::USignal = cComponent::registerSignal("U");
simsignal_t OrbtcpNoEstRTTFlavour::additiveIncreaseSignal = cComponent::registerSignal("additiveIncrease");
simsignal_t OrbtcpNoEstRTTFlavour::sharingFlowsSignal = cComponent::registerSignal("sharingFlows");
simsignal_t OrbtcpNoEstRTTFlavour::bottleneckBandwidthSignal = cComponent::registerSignal("bottleneckBandwidth");
simsignal_t OrbtcpNoEstRTTFlavour::avgRttSignal = cComponent::registerSignal("avgRtt");
simsignal_t OrbtcpNoEstRTTFlavour::queueingDelaySignal = cComponent::registerSignal("queueingDelay");
simsignal_t OrbtcpNoEstRTTFlavour::estimatedRttSignal = cComponent::registerSignal("estimatedRtt");
simsignal_t OrbtcpNoEstRTTFlavour::avgEstimatedRttSignal = cComponent::registerSignal("avgEstimatedRtt");
simsignal_t OrbtcpNoEstRTTFlavour::alphaSignal = cComponent::registerSignal("alpha");
simsignal_t OrbtcpNoEstRTTFlavour::measuringInflightSignal = cComponent::registerSignal("measuringInflight");
simsignal_t OrbtcpNoEstRTTFlavour::txBytesSignal = cComponent::registerSignal("txBytes");

simsignal_t OrbtcpNoEstRTTFlavour::testRttSignal = cComponent::registerSignal("testRtt");

simsignal_t OrbtcpNoEstRTTFlavour::sndUnaSignal = cComponent::registerSignal("sndUna");
simsignal_t OrbtcpNoEstRTTFlavour::sndMaxSignal = cComponent::registerSignal("sndMax");

simsignal_t OrbtcpNoEstRTTFlavour::recoveryPointSignal = cComponent::registerSignal("recoveryPoint");

OrbtcpNoEstRTTFlavour::OrbtcpNoEstRTTFlavour() : OrbtcpFamily(),
    state((OrbtcpStateVariables *&)TcpAlgorithm::state)
{
}

OrbtcpNoEstRTTFlavour::~OrbtcpNoEstRTTFlavour() {
    cancelEvent(reactTimer);
    delete reactTimer;
}

void OrbtcpNoEstRTTFlavour::initialize()
{
...
void OrbtcpNoEstRTTFlavour::established(bool active)
{
...
void OrbtcpNoEstRTTFlavour::rttMeasurementComplete(simtime_t tSent, simtime_t tAcked)
{
    //
...
void OrbtcpNoEstRTTFlavour::receivedDataAck(uint32_t firstSeqAcked, const IntDataVec& intData)
{
...
void OrbtcpNoEstRTTFlavour::receivedDuplicateAck(uint32_t firstSeqAcked, const IntDataVec& intData)
{
...
double OrbtcpNoEstRTTFlavour::measureInflight(const IntDataVec& intData)
{
...
uint32_t OrbtcpNoEstRTTFlavour::computeWnd(double u, bool updateWc)
{
    uint32_t targetW;
    if(u >= state->eta) {
...
size_t OrbtcpNoEstRTTFlavour::getConnId()
{
    return connId;
}

simtime_t OrbtcpNoEstRTTFlavour::getRtt()
{
    return state->srtt;
}

simtime_t OrbtcpNoEstRTTFlavour::getEstimatedRtt()
{
    return state->srtt;
}

void OrbtcpNoEstRTTFlavour::processRexmitTimer(TcpEventCode &event) {
...
void OrbtcpNoEstRTTFlavour::processTimer(cMessage *timer, TcpEventCode& event)
{
    if(timer == reactTimer){
        updateWindow = true;
        pathChanged = false;
