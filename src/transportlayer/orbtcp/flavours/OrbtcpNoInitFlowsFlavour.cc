...
void OrbtcpNoInitFlowsFlavour::receivedDataAck(uint32_t firstSeqAcked, IntDataVec intData)
{
...
double OrbtcpNoInitFlowsFlavour::measureInflight(IntDataVec intData)
{
