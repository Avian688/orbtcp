...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPNOAVGRTTFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPNOAVGRTTFLAVOUR_H_
 ...
 * Implements OrbTCP.
 */
class OrbtcpNoAvgRTTFlavour : public OrbtcpFamily
{
  protected:
