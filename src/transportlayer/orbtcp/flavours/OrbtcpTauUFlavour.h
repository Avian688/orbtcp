...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPTAUUFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPTAUUFLAVOUR_H_
 ...
 */
typedef OrbtcpFamilyStateVariables OrbtcpTauUStateVariables;

/**
 * Implements OrbTCP.
 */
class OrbtcpTauUFlavour : public OrbtcpFamily
{
  protected:
    OrbtcpTauUStateVariables *& state;
    ...
    {
        return new OrbtcpTauUStateVariables();
    }
