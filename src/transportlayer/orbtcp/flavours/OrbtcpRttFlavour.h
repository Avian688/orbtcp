...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPRTTFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPRTTFLAVOUR_H_
 ...
 */
typedef OrbtcpFamilyStateVariables OrbtcpRttStateVariables;

/**
 * Implements OrbTCP.
 */
class OrbtcpRttFlavour : public OrbtcpFamily
{
  protected:
    OrbtcpRttStateVariables *& state;
    ...
    {
        return new OrbtcpRttStateVariables();
    }
