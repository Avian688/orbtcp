...
Register_Class(OrbtcpTauUFlavour);

simsignal_t OrbtcpTauUFlavour::txRateSignal = cComponent::registerSignal("txRate");
simsignal_t OrbtcpTauUFlavour::tauSignal = cComponent::registerSignal("tau");
simsignal_t OrbtcpTauUFlavour::uSignal = cComponent::registerSignal("u");
simsignal_t OrbtcpTauUFlavour::USignal = cComponent::registerSignal("U");
simsignal_t OrbtcpTauUFlavour::additiveIncreaseSignal = cComponent::registerSignal("additiveIncrease");
simsignal_t OrbtcpTauUFlavour::sharingFlowsSignal = cComponent::registerSignal("sharingFlows");
simsignal_t OrbtcpTauUFlavour::bottleneckBandwidthSignal = cComponent::registerSignal("bottleneckBandwidth");
simsignal_t OrbtcpTauUFlavour::avgRttSignal = cComponent::registerSignal("avgRtt");
simsignal_t OrbtcpTauUFlavour::queueingDelaySignal = cComponent::registerSignal("queueingDelay");
simsignal_t OrbtcpTauUFlavour::estimatedRttSignal = cComponent::registerSignal("estimatedRtt");
simsignal_t OrbtcpTauUFlavour::avgEstimatedRttSignal = cComponent::registerSignal("avgEstimatedRtt");

OrbtcpTauUFlavour::OrbtcpTauUFlavour() : OrbtcpFamily(),
    state((OrbtcpTauUStateVariables *&)TcpAlgorithm::state)
{
}

void OrbtcpTauUFlavour::initialize()
{
...
void OrbtcpTauUFlavour::established(bool active)
{
...
void OrbtcpTauUFlavour::rttMeasurementComplete(simtime_t tSent, simtime_t tAcked)
{
    //
...
void OrbtcpTauUFlavour::receivedDataAckInt(uint32_t firstSeqAcked, IntDataVec intData)
{
...
double OrbtcpTauUFlavour::measureInflight(IntDataVec intData)
{
    double u = 0;
    double tau;
...
uint32_t OrbtcpTauUFlavour::computeWnd(double u, bool updateWc)
{
    uint32_t w;
...
size_t OrbtcpTauUFlavour::getConnId()
{
    return connId;
}

simtime_t OrbtcpTauUFlavour::getSrtt()
{
    //return state->srtt;
    return estimatedRtt;
}

unsigned int OrbtcpTauUFlavour::getCwnd()
{
