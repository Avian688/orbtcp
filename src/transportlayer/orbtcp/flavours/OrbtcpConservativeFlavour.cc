...
#include "OrbtcpConservativeFlavour.h"
...
Register_Class(OrbtcpConservativeFlavour);

simsignal_t OrbtcpConservativeFlavour::txRateSignal = cComponent::registerSignal("txRate");
simsignal_t OrbtcpConservativeFlavour::tauSignal = cComponent::registerSignal("tau");
simsignal_t OrbtcpConservativeFlavour::uSignal = cComponent::registerSignal("u");
simsignal_t OrbtcpConservativeFlavour::USignal = cComponent::registerSignal("U");
simsignal_t OrbtcpConservativeFlavour::additiveIncreaseSignal = cComponent::registerSignal("additiveIncrease");
simsignal_t OrbtcpConservativeFlavour::sharingFlowsSignal = cComponent::registerSignal("sharingFlows");
simsignal_t OrbtcpConservativeFlavour::bottleneckBandwidthSignal = cComponent::registerSignal("bottleneckBandwidth");
simsignal_t OrbtcpConservativeFlavour::avgRttSignal = cComponent::registerSignal("avgRtt");
simsignal_t OrbtcpConservativeFlavour::queueingDelaySignal = cComponent::registerSignal("queueingDelay");
simsignal_t OrbtcpConservativeFlavour::estimatedRttSignal = cComponent::registerSignal("estimatedRtt");
simsignal_t OrbtcpConservativeFlavour::avgEstimatedRttSignal = cComponent::registerSignal("avgEstimatedRtt");
simsignal_t OrbtcpConservativeFlavour::alphaSignal = cComponent::registerSignal("alpha");

OrbtcpConservativeFlavour::OrbtcpConservativeFlavour() : OrbtcpFamily(),
    state((OrbtcpConservativeStateVariables *&)TcpAlgorithm::state)
{
}

void OrbtcpConservativeFlavour::initialize()
{
...
void OrbtcpConservativeFlavour::established(bool active)
{
...
void OrbtcpConservativeFlavour::rttMeasurementComplete(simtime_t tSent, simtime_t tAcked)
{
    //
...
void OrbtcpConservativeFlavour::receivedDataAckInt(uint32_t firstSeqAcked, IntDataVec intData)
{
...
double OrbtcpConservativeFlavour::measureInflight(IntDataVec intData)
{
    double u = 0;
    double tau;
...
uint32_t OrbtcpConservativeFlavour::computeWnd(double u, bool updateWc)
{
    uint32_t w;
...
size_t OrbtcpConservativeFlavour::getConnId()
{
    return connId;
}

simtime_t OrbtcpConservativeFlavour::getSrtt()
{
    //return state->srtt;
    return estimatedRtt;
}

unsigned int OrbtcpConservativeFlavour::getCwnd()
{
