...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_HPCCFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_HPCCFLAVOUR_H_
 ...
 */
typedef OrbtcpFamilyStateVariables HpccStateVariables;

/**
 * Implements HPCC.
 */
class HpccFlavour : public OrbtcpFamily
{
  protected:
