...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPNOSSAVGRTTAIFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCPNOSSAVGRTTAIFLAVOUR_H_
 ...
 */
typedef OrbtcpFamilyStateVariables OrbtcpNoSSSAvgRTTAItateVariables;

/**
 * Implements OrbTCPNoSS.
 */
class OrbtcpNoSSAvgRttAIFlavour : public OrbtcpFamily
{
  protected:
    OrbtcpNoSSSAvgRTTAItateVariables *& state;
    ...
    {
        return new OrbtcpNoSSSAvgRTTAItateVariables();
    }
