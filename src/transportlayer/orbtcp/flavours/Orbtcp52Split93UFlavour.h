...
#ifndef TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCP52SPLIT93UFLAVOUR_H_
#define TRANSPORTLAYER_ORBTCP_FLAVOURS_ORBTCP52SPLIT93UFLAVOUR_H_
...
/**
 * State variables for Orbtcp52Split93UFlavour.
 */
typedef OrbtcpFamilyStateVariables Orbtcp52Split93UStateVariables;

/**
 * Implements Orbtcp52Split93UFlavour.
 */
class Orbtcp52Split93UFlavour : public OrbtcpFamily
{
  protected:
    Orbtcp52Split93UStateVariables *& state;
    ...
    {
        return new Orbtcp52Split93UStateVariables();
    }
